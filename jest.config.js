...
module.exports = {
  ...
  // all test suites globalSetup: undefined,
  ...
  // maxWorkers: 10% will use 10% of your CPU amount + 1 as the maximum worker number. maxWorkers: 2
  // will use a maximum of 2 workers. maxWorkers: "50%",
  ...
  // out resources with a single module moduleNameMapper: {},
  ...
  //  such in the results. slowTestThreshold: 5,
